        ...
        <div className={styles.baner_wrap}>
            ...
            <div className={styles.baner_container}>
                <div className={styles.baner_text}>
                    <h1>БЛАГОДІЙНА ОРГАНІЗАЦІЯ "КОНФЕРЕНЦІЯ БЛАЖЕННОЇ МАРТИ ВЄЦКОЇ"</h1>
                    <p>Міжнародна християнська благодійна організація мирян, яка об’єднує близько 600 тисяч людей</p>
                </div>
